...
public class Player {
    ...
    /**
     * static getPlayerSourceInstance
     */
    public static PlayerSource getPlayerSourceInstance(final Player player) {
    ...
    private void bookmarkPodcast() {
        if (source != null && source.getAudioFile() != null) {
            String name = source.getAudioCollection().getName();
            PodcastBookmark currentBookmark = new PodcastBookmark(name,
     ...
     * @return the stats
     */
    public PlayerStats getStats(final User user) {
        String filename = "";
        int duration = 0;
        if (source != null && source.getAudioFile() != null) {
